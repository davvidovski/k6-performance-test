...
// Custom metrics
const responseTimeTrend = new Trend('response_time'); // Tracks response times
...
export default function () {
    group('Get URLs', function () {
        urls.forEach(url => {
            ...
            responseTimeTrend.add(response.timings.duration); // Record the response time in the custom trend metric
